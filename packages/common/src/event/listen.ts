export type MethodDecoratorFactoryFunction = (
  target: any,
  key: string | number,
...
export function Listen(
  ...
  return function decorator(
    ...
    target.connectedCallback = function connectedCallbackWraper() {
      connectedCallback.call(this);
      addListener.call(this);
    };

    target.disconnectedCallback = function disconnectedCallbackWraper() {
